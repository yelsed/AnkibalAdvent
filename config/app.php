...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When enabled, allows unlocking calendar days regardless of date restrictions.
    | This is useful for testing. Set CALENDAR_DEBUG_MODE=true in your .env file.
    |
    */

    'calendar_debug_mode' => (bool) env('CALENDAR_DEBUG_MODE', false),
